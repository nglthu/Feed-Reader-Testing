...
* Good tests give me the ability to quickly analyze whether new code breaks an existing feature within your codebase, without having to manually test all of the functionality.
...
11. Write a test that ensures the menu element is hidden by default. I'll have to analyze the HTML and the CSS to determine how they're performing the hiding/showing of the menu element.
